...
//                + "kc_house_data.csv");
        ...
        train_poly.open("G:\\coursera\\Machine Learning - Regression\\"
                + "week 3 - Assessing Performance\\06 - Programming assignment\\"
        ...
        MultipleLinearRegression model2 = new MultipleLinearRegression(
                train_poly.getFeatures("power_2"), train_poly.getFeature("price"));
        model2.getCoefficients();
        double[] model2_predict = model2.predictOutcome(poly1_data.getFeatures("power_2"));

        System.out.println("\nModel 3");
        MultipleLinearRegression model3 = new MultipleLinearRegression(
                train_poly.getFeatures("power_3"), train_poly.getFeature("price"));
        ...
        double[] model4_predict = model4.predictOutcome(poly1_data.getFeatures("power_1","power_2","power_3"));

        System.out.println("\nModel 5");
        MultipleLinearRegression model5 = new MultipleLinearRegression(
                train_poly.getFeatures("power_15"), train_poly.getFeature("price"));
        model5.getCoefficients();
        double[] model5_predict = model5.predictOutcome(poly1_data.getFeatures("power_15"));
        
//        Util.mostrarVector("model1 \t model2 \t model3 \t model4 \t model5"
//                , model1_predict, model2_predict, model3_predict, model4_predict, model5_predict);
